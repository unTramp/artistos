  ...
  return (
    <main className="shell">
      <aside className="sidebar">
        ...
        <nav aria-label="Primary"><a className="active" href="#overview">Overview</a><a href="#foundation">Foundation</a></nav>
      ...
      <section className="content" id="overview">
        ...
        <section className="focus"><p className="eyebrow">CURRENT FOCUS</p><h2>Make the architecture executable</h2><p>Authenticated request → application command → domain → PostgreSQL/outbox → worker → trace.</p></section>
      </section>
    </main>
  );
}
