...
5. `parentAssetId` may remain temporarily as a compatibility/convenience projection for single-parent assets but is not canonical in v1.4.
...
**APPROVED for MASTER v1.4:** add AssetDerivation edge table and deprecate singular parent as canonical truth.
