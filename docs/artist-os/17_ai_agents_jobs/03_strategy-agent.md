...
- **MASTER references:** §326, §341–346
- **Domain:** 17_ai_agents_jobs
- **Feature slug:** `strategy-agent`
- **Requirement prefix:** `AI-STR`

## 2. Purpose
Recommend what to create/test next and why using identity, song, campaign, audience, market and validated evidence.
...
## 4. Scope
### In scope
- angle/strategy recommendations
...
## 14. Business rules
- `AI-STR-001` validated own evidence gains weight as system matures
- `AI-STR-002` cold start must not fake personalization
- `AI-STR-003` must respect Identity/hard rules
- `AI-STR-004` must explain why/uncertainty/learning value
- `AI-STR-005` cannot auto-publish/change identity
- `AI-STR-006` bounded variants/infinite-generation protection
- `AI-STR-007` creative exception remains valid
...
- `AI-STR-AC01` The feature follows its MASTER role/permission boundary.
- `AI-STR-AC02` Provider failure leaves a usable manual/deterministic product path where applicable.
- `AI-STR-AC03` Every run is tied to configuration/context metadata.
- `AI-STR-AC04` No publish/delete/spend occurs without explicit approval.
