...
- **MASTER references:** §328, §287–315
- **Domain:** 17_ai_agents_jobs
- **Feature slug:** `analytics-agent`
- **Requirement prefix:** `AI-ANA`

## 2. Purpose
Interpret structured metrics/evidence conservatively and create bounded Insights without inventing missing data.
...
## 14. Business rules
- `AI-ANA-001` structured data only for quantitative claims
- `AI-ANA-002` missing metric never invented
- `AI-ANA-003` correlation not causation
- `AI-ANA-004` sample/outlier/confidence disclosed
- `AI-ANA-005` no automatic Learning validation
- `AI-ANA-006` no cross-platform raw ranking
- `AI-ANA-007` inconclusive is valid output
...
- `AI-ANA-AC01` The feature follows its MASTER role/permission boundary.
- `AI-ANA-AC02` Provider failure leaves a usable manual/deterministic product path where applicable.
- `AI-ANA-AC03` Every run is tied to configuration/context metadata.
- `AI-ANA-AC04` No publish/delete/spend occurs without explicit approval.
