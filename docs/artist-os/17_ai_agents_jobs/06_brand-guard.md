# Brand / Identity Guard Agent

- **Status:** REVIEW COMPLETE
- **MASTER references:** §329–330, §89, §117
- **Domain:** 17_ai_agents_jobs
- **Feature slug:** `brand-guard`
- **Requirement prefix:** `AI-GRD`

## 2. Purpose
Check output for tone, generic AI patterns, repetition, facts, identity/mystique/era and rights concerns with explainable warnings.
...
- tone/anti-AI checks
- factual grounding
- mystique/rights warnings
- intentional deviation support
...
## 14. Business rules
- `AI-GRD-001` no magic score required
- `AI-GRD-002` must explain warning
- `AI-GRD-003` intentional approved deviations allowed
- `AI-GRD-004` cannot rewrite identity automatically
- `AI-GRD-005` private/protected narrative not leaked
- `AI-GRD-006` rights warning not legal ownership assertion
- `AI-GRD-007` false positives feed evals
...
- `AI-GRD-AC01` The feature follows its MASTER role/permission boundary.
- `AI-GRD-AC02` Provider failure leaves a usable manual/deterministic product path where applicable.
- `AI-GRD-AC03` Every run is tied to configuration/context metadata.
- `AI-GRD-AC04` No publish/delete/spend occurs without explicit approval.
