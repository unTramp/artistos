...
- **MASTER references:** §327, §160–191, §330
- **Domain:** 17_ai_agents_jobs
- **Feature slug:** `production-agent`
- **Requirement prefix:** `AI-PRD`

## 2. Purpose
Turn approved creative intent into feasible production plans constrained by real equipment, locations, rights and identity.
...
## 14. Business rules
- `AI-PRD-001` must use actual capability profile
- `AI-PRD-002` must provide feasible fallback when requirement unavailable
- `AI-PRD-003` cannot invent owned gear/location/crew
- `AI-PRD-004` rights warnings preserved
- `AI-PRD-005` identity constraints concise/actionable
- `AI-PRD-006` cannot execute shoot/publish
- `AI-PRD-007` approved Angle remains source intent
...
- `AI-PRD-AC01` The feature follows its MASTER role/permission boundary.
- `AI-PRD-AC02` Provider failure leaves a usable manual/deterministic product path where applicable.
- `AI-PRD-AC03` Every run is tied to configuration/context metadata.
- `AI-PRD-AC04` No publish/delete/spend occurs without explicit approval.
