# Model Routing & AI Cost

- **Status:** REVIEW COMPLETE
- **MASTER references:** §337–347
- **Domain:** 17_ai_agents_jobs
- **Feature slug:** `model-routing`
- **Requirement prefix:** `AI-MDL`

## 2. Purpose
Route high-reasoning work to capable models and tagging/classification to cheaper models only when eval quality is sufficient.
...
## 14. Business rules
- `AI-MDL-001` routing based on eval evidence
- `AI-MDL-002` high reasoning for research synthesis/weekly strategy/complex analytics
- `AI-MDL-003` cheap model only if quality sufficient
- `AI-MDL-004` provider/model not domain dependency
- `AI-MDL-005` cache stable summaries/capsules with version invalidation
- `AI-MDL-006` fine-tuning excluded from MVP
- `AI-MDL-007` UI core pages cannot wait on model
...
- `AI-MDL-AC01` The feature follows its MASTER role/permission boundary.
- `AI-MDL-AC02` Provider failure leaves a usable manual/deterministic product path where applicable.
- `AI-MDL-AC03` Every run is tied to configuration/context metadata.
- `AI-MDL-AC04` No publish/delete/spend occurs without explicit approval.
