...
- **MASTER references:** §335–336
- **Domain:** 17_ai_agents_jobs
- **Feature slug:** `prompt-registry`
- **Requirement prefix:** `AI-PRM`

## 2. Purpose
Version prompts, schemas, guardrails, evals and configurations as code/artifacts rather than scattered strings.
...
## 14. Business rules
- `AI-PRM-001` prompts/schemas/guards/evals/configs organized
- `AI-PRM-002` run references version
- `AI-PRM-003` changes reviewed/tested
- `AI-PRM-004` secrets not embedded
- `AI-PRM-005` structured schema versioned with prompt
- `AI-PRM-006` deprecated versions retained enough for reproducibility
...
- `AI-PRM-AC01` The feature follows its MASTER role/permission boundary.
- `AI-PRM-AC02` Provider failure leaves a usable manual/deterministic product path where applicable.
- `AI-PRM-AC03` Every run is tied to configuration/context metadata.
- `AI-PRM-AC04` No publish/delete/spend occurs without explicit approval.
