...
- **MASTER references:** §336, §333–344, §393
- **Domain:** 17_ai_agents_jobs
- **Feature slug:** `evals`
- **Requirement prefix:** `AI-EVL`

## 2. Purpose
Use golden datasets and task-specific criteria to detect generic, ungrounded or identity-breaking AI regressions before config promotion.
...
### In scope
- golden datasets
- grounding/tone/identity/mystique/analytics/novelty/actionability
- canary comparison
- acceptance metrics
...
## 14. Business rules
- `AI-EVL-001` must include artist-aligned vs generic cases
- `AI-EVL-002` analytics eval penalizes invented metrics
- `AI-EVL-003` guard eval includes intentional deviations
- `AI-EVL-004` subjective creative quality needs human review
- `AI-EVL-005` eval datasets/versioning preserved
- `AI-EVL-006` cost/latency tracked separately from quality
- `AI-EVL-007` fine-tuning not default solution
...
- `AI-EVL-AC01` The feature follows its MASTER role/permission boundary.
- `AI-EVL-AC02` Provider failure leaves a usable manual/deterministic product path where applicable.
- `AI-EVL-AC03` Every run is tied to configuration/context metadata.
- `AI-EVL-AC04` No publish/delete/spend occurs without explicit approval.
